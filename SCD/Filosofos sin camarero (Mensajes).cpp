...
#include <mpi.h>
#define CogerTenedor 22 // Número cualquiera
#define SoltarTenedor 33 // Número cualquiera
#define FilosofoAntisistema	 0
...
// Para evitar interbloqueo, basta con que algún filósofo coja los tenedores al revés. 
void Filosofo( int id, int nprocesos )	
{
   ...
   while(1)
   {
      ...
      if( id == FilosofoAntisistema ){	// Coge los tenedores al revés
