(define ( problem ejercicio1 )
    ...
    (:init
        ...
        (= ( bolsillo_capacidad_total dicaprio1 ) 0 )
        (= ( bolsillo_capacidad_total princesa1 ) 1 )
        (= ( bolsillo_capacidad_total principe1 ) 0 )
        (= ( bolsillo_capacidad_total bruja1 ) 2 )
        (= ( bolsillo_capacidad_total profesor1 ) 0 )
