(define ( problem ejercicio1 )
    ...
    (:goal
        ( and ( personaje_tiene_objeto dicaprio1 ) ( personaje_tiene_objeto bruja1 ) ( personaje_tiene_objeto profesor1 )
        ( personaje_tiene_objeto princesa1 ) ( personaje_tiene_objeto principe1) )
    )
